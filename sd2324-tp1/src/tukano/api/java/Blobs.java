...
public interface Blobs {
	 ...
	 * 
	 * @param blobId the identifier generated by the Shorts service for this blob
	 * @param bytes  the contents in bytes of the blob resource
	 * @param timestamp the maximum time to download  the blob;
	 * @param verifier the shared secret key to verify
	 ...
	 */
	Result<Void> upload(String blobId, byte[] bytes, long timestamp, String verifier);
	 ...
	 * 			 NOT_FOUND, if no blob matches the provided blobId
	 */
	Result<byte[]> download(String blobId, long timestamp, String verifier);
